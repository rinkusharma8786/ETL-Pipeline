...
# Dashboard Visualization & Deployment (Milestone 4)

## 1. Overview

In this milestone, the processed options market data was transformed into an interactive analytical dashboard for visualization and monitoring.

The goal of this milestone was to build a user-facing layer on top of the ETL pipeline, allowing real-time exploration of market insights such as volatility, sentiment, strike activity, and option chain behavior.

The dashboard was developed using Streamlit and connected directly to the SQLite database generated by the Apache Airflow pipeline.
...
- Build an interactive dashboard for processed options data
- Visualize key market indicators
- Integrate dashboard with the ETL pipeline output
- Add auto-refresh functionality for updated data
- Make the project more usable and presentation-ready

---

## 3. Dashboard Architecture

The dashboard is built on top of the ETL pipeline outputs.
